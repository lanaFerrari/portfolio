...
var db = [{
  ...
  description: "Website where the user can perfom full CRUD and navigate through the pages.",
  tech: ["React", "Node.js", "Javascript", "PostgreSQL"],
  ...
  description: "Practice writing models with relationships for an API of an artist exhibition management service.",
  tech: ["HTML", "CSS"],
