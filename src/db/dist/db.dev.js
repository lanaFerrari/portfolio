...
var db = [{
  ...
  title: "Calculator",
  description: "Calculator built completely in Javascript. The end goal is to have a site which can accept inputs, do some calculations and give you the outputs. The inputs will be generated from users clicking on the calculator buttons.",
  tech: ["Javascript", "HTML", "SCSS"],
  ...
  photo: "checkers.jpg",
  title: "Checkers Game",
  description: "Website to practice authentication using Bcrypt and Token where the user can also play Checkers Game.",
  ...
  description: "Full CRUD Exercise, this project was created in group with 2 other developers: Viktorija and Rafael. The user can include, exclude and edit projects as well as see them on the main page.",
  tech: ["React", "Node.js", "Javascript", "PostgreSQL"],
  ...
  description: "One of the first website I created using only  HTML and CSS. The main goal was to practice accessibility and responsiveness.",
  tech: ["HTML", "CSS"],
